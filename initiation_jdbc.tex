...
\begin{figure}\centering
  \begin{agrandirmarges}{1cm}{1cm}
    ...
    \hfill%
    \subfloat[][Fenêtre de selection du fichier \url{~/net-home/tp/tpCas2/ojdbc14.jar} \label{capture4}]{\includegraphics[width=0.48\linewidth]{capture4}}%
    \caption{}
  \end{agrandirmarges}
\end{figure}
...
\url{http://allegro.iut.univ-aix.fr/~nedjar/gestion_peda_oracle.sql} ou \url{http://allegro.iut.univ-aix.fr/~nedjar/gestion_peda_mysql.sql}}~» que vous avez 
